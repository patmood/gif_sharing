...
Gif.create(url: 'http://i.minus.com/iIzlOlv8DCkYL.gif', token: 'largefile')
Gif.create(url: 'http://i.imgur.com/iK8OrqF.gif', token: 'iK8OrqF')
Gif.create(url: 'http://i.imgur.com/eIMXL.gif', token: 'eIMXL')
Gif.create(url: 'http://i.imgur.com/zvKp6T6.gif', token: 'zvKp6T6')
